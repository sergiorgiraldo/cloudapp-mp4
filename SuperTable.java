...
/*
Your	application	creates	a	new	table	named	“powers”	in	HBase	and	populates it	with	the following data:

Row key     personal                professional
            hero        power       name        xp
row1        superman    strength    clark       100
row2        batman      money       bruce       50
row3        wolverine   healing     logan       75

After	that,	output	the	results	from	scanning the	personal.hero	column	of	the	table	to	the standard	output	(console)
*/
...
public class SuperTable{
   ...
   public static void main(String[] args) throws IOException {
      ...
      p1.add(Bytes.toBytes("professional"),
      ...
      p2.add(Bytes.toBytes("professional"),
      ...
      // row 3
      Put p3 = new Put(Bytes.toBytes("row2"));
